...
export default {
  ...
  methods: {
    ...
    saveTags () {
      // Chame a função para salvar as etiquetas aqui, semelhante ao que você estava fazendo no @input do q-select
      // Por exemplo: this.tagSelecionada(this.selectedTags);
      this.closeTagModal()
    },
    openWalletModal () {
    ...
    saveWallets () {
      // Chame a função para salvar as carteiras aqui, semelhante ao que você estava fazendo no @input do q-select
      // Por exemplo: this.carteiraDefinida(this.selectedWallets);
